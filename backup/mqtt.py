    ...
    with mqtt_mutex:
        ...
        try:
            ...
            if (
                ...
                and global_mqtt.client_cert_path
                and global_mqtt.client_key_path
            ):
...
def publish_new_tone_detection(
    frequency: float, duration_ms: int, range_hz: int
) -> bool:
...
def publish_new_tone_pair(tone_a_hz: float, tone_b_hz: float) -> bool:
    ...
    try:
        ...
        message = {
            "device_id": device_id,
            "timestamp": int(time.time()),
            "tone_details": {"tone_a_hz": tone_a_hz, "tone_b_hz": tone_b_hz},
        }
