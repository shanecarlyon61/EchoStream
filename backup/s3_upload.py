...
def write_audio_samples_to_recording(samples: list, sample_count: int, sample_rate: int) -> bool:
...
def start_known_tone_audio_recording(tone_a_hz: float, tone_b_hz: float, duration_ms: int) -> bool:
...
def write_audio_samples_to_known_recording(samples: list, sample_count: int, sample_rate: int) -> bool:
